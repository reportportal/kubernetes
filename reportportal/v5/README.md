...
```sh
helm install --name <postgresql_chart_name> --set postgresqlUsername=rpuser,postgresqlPassword=<rpuser_password>,postgresqlDatabase=reportportal -f ./reportportal/postgresql/values.yaml ./reportportal/charts/postgresql-8.4.0.tgz
```
